...
namespace OpenCartNET.OpenCart
{
    ...
    public class Product
    {
        ...
        [DataMember(EmitDefaultValue = false)]
        public List<Product_Description> product_description { get; set; }
        ...
        [DataMember(EmitDefaultValue = false)]
        public List<List<ProductCategory>> category { get; set; }
        [DataMember(EmitDefaultValue = false)]
    ...
    public class Option_Value
    {
        ...
        [DataMember(EmitDefaultValue = false)]
        public object price_formated { get; set; }
    ...
    public class BulkProductUpdate
    {
